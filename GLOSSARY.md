...
| **Queue manager** | The role that can create, configure, start/stop, and manage auto-assigners. Implemented as the scoped role `x_<scope>_queue_manager` to avoid colliding with any pre-existing role of the same informal name. |
