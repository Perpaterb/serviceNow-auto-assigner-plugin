...
means a user with the scoped `x_<scope>_queue_manager` role; "analyst" means
...
**As** a platform admin
**I want** the app to provide a scoped `x_<scope>_queue_manager` role
...
- AC2: Without `x_<scope>_queue_manager`, I see a **stripped read-only
