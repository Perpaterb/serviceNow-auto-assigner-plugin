...
ServiceNow Auto-Assigner is a scoped application that distributes incoming
...
![ServiceNow Auto-Assigner overview](screenshots/Admin_and_queue_manager_view.png)

---

- **[Installation Guide](install-guide.md)** — connect to GitHub and import the app into your instance.
